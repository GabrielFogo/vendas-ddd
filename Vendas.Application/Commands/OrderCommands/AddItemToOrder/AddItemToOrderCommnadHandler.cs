...
public sealed class AddItemToOrderCommandHandler(IOrderRepository orderRepository)
    : ICommandHandler<AddItemsToOrderCommand, AddItemToOrderResultDto>
{
    public async Task<AddItemToOrderResultDto> HandleAsync(AddItemsToOrderCommand command,
